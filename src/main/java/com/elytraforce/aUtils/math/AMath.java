...
public class AMath {
    ...
    public static double threadRandom(double min, double max) { return ThreadLocalRandom.current().nextDouble(min, max); }
    public static int threadRandInt(int min, int max) { return ThreadLocalRandom.current().nextInt(min, max + 1); }
