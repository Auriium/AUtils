...
/*
I copied and pasted this from mybatis because i was sick of shading it in and wasting
space. I am not going to be optimizing or editing this class because it is not mine.
*/
...
public class IbatisScriptRunner {
    ...
    public IbatisScriptRunner(Connection connection) {
